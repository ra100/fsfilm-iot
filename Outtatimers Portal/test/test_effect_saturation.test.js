...
function testSaturationConstraintsInEffects() {
  ...
  // Simulate how the portal effect uses saturation values
  function simulatePortalEffectColorGeneration(hue, satMin, satMax) {
  ...
  testCases.forEach(({ satMin, satMax, name }) => {
    const colors = []
    for (let i = 0; i < 10; i++) {
      colors.push(simulatePortalEffectColorGeneration(180, satMin, satMax))
    }
