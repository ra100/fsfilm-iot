 ...
 */
void test_timing_config_constants(void) {
    TEST_ASSERT_EQUAL(200, ControllerConfig::Timing::DEBOUNCE_DELAY);
    TEST_ASSERT_EQUAL(20, ControllerConfig::Timing::EFFECT_UPDATE_INTERVAL);
}
...
void test_config_value_ranges(void) {
    ...
    TEST_ASSERT_GREATER_THAN(0, ControllerConfig::Timing::DEBOUNCE_DELAY);
...
extern "C" void app_main(void) {
    ...
    RUN_TEST(test_timing_config_constants);
